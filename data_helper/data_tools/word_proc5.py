...
with open(os.path.join(dir_name,'annotated' ,str(sys.argv[1]) + '.tsv'), 'r', encoding='utf8') as f_r:
# with open(os.path.join(dir_name,'annotated' ,'category_msn.tsv'), 'r', encoding='utf8') as f_r:
